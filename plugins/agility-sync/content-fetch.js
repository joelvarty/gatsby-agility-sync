...
var debug = __webpack_require__(100)("follow-redirects");
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(47), __webpack_require__(117), __webpack_require__(187), __webpack_require__(19), __webpack_require__(73), __webpack_require__(188), __webpack_require__(194), __webpack_require__(209), __webpack_require__(234));
	else {}
...
/* harmony import */ var core_js_modules_es6_number_is_finite__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! core-js/modules/es6.number.is-finite */ "./node_modules/core-js/modules/es6.number.is-finite.js");
/* harmony import */ var core_js_modules_es6_number_is_finite__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_number_is_finite__WEBPACK_IMPORTED_MODULE_9__);
...
var makeConfig = function makeConfig() {
  ...
  config.key = Object(_cache__WEBPACK_IMPORTED_MODULE_4__["key"])(config);
  config.invalidate = Object(_cache__WEBPACK_IMPORTED_MODULE_4__["invalidate"])(config); // If debug mode is on, create a simple logger method
...
function () {
  function RedisStore(client) {
    ...
    if (lodash_get__WEBPACK_IMPORTED_MODULE_6___default()(client, 'constructor.name') !== 'RedisClient') {
...
var http = __webpack_require__(52);
var https = __webpack_require__(53);
var httpFollow = __webpack_require__(54).http;
var httpsFollow = __webpack_require__(54).https;
var url = __webpack_require__(55);
...
const os = __webpack_require__(106);
...
var baseMerge = __webpack_require__(195),
...
var arrayMap = __webpack_require__(42),
    ...
    customOmitClone = __webpack_require__(229),
...
var cloneArrayBuffer = __webpack_require__(45),
    ...
    cloneRegExp = __webpack_require__(219),
    cloneSymbol = __webpack_require__(220),
    cloneTypedArray = __webpack_require__(78);
...
var castPath = __webpack_require__(24),
    ...
    parent = __webpack_require__(227),
    toKey = __webpack_require__(15);
...
var baseKeys = __webpack_require__(39),
    ...
    stringSize = __webpack_require__(235);
...
var asciiSize = __webpack_require__(236),
    hasUnicode = __webpack_require__(237),
    unicodeSize = __webpack_require__(238);
...
// EXTERNAL MODULE: ./node_modules/axios-cache-adapter/dist/cache.node.js
var cache_node = __webpack_require__(88);

// CONCATENATED MODULE: ./src/utils.js
function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function logError(consoleMessage) {
...
function buildRequestUrlPath(config, languageCode) {
  ...
  var urlPath = "".concat(config.baseUrl, "/").concat(apiFetchOrPreview, "/").concat(languageCode);
  return urlPath;
}

function buildPathUrl(contentType, referenceName, skip, take, sort, direction, filters, filtersLogicOperator, contentLinkDepth) {
  var url = "/".concat(contentType, "/").concat(referenceName, "?contentLinkDepth=").concat(contentLinkDepth, "&");
  filtersLogicOperator = filtersLogicOperator ? " ".concat(filtersLogicOperator, " ") : ' AND ';

  if (sort) {
    url += "sort=".concat(sort, "&");
    if (direction) {
      url += "direction=".concat(direction, "&");
    }
  }

  if (skip) {
    url += "skip=".concat(skip, "&");
  }

  if (take) {
    url += "take=".concat(take, "&");
  }
  ...
  if (filters && filters.length > 0) {
    ...
    for (var i = 0; i < filters.length; i++) {
      ...
      url += "".concat(filter.property, "[").concat(filter.operator, "]").concat(filter.value) + (i < filters.length - 1 ? filtersLogicOperator : '');
    }
    url += '&';
  }
  return url;
...
// CONCATENATED MODULE: ./src/methods/getSitemapFlat.js
...
function getSitemapFlat(requestParams) {
  ...
  var req = {
    url: "/sitemap/flat/".concat(requestParams.channelName),
    method: 'get',
...
/* harmony default export */ var methods_getSitemapFlat = (getSitemapFlat);
// CONCATENATED MODULE: ./src/methods/getSitemapNested.js
...
function getSitemapNested(requestParams) {
  ...
  getSitemapNested_validateRequestParams(requestParams);

  var req = {
    url: "/sitemap/nested/".concat(requestParams.channelName),
    method: 'get',
    baseURL: buildRequestUrlPath(this.config, requestParams.languageCode),
    headers: buildAuthHeader(this.config),
    params: {} };
...
function getSitemapNested_validateRequestParams(requestParams) {
  if (!requestParams.languageCode) {
    throw new TypeError('You must include a languageCode in your request params.');
  } else if (!requestParams.channelName) {
    throw new TypeError('You must include a channelName in your request params.');
...
/* harmony default export */ var methods_getSitemapNested = (getSitemapNested);
// CONCATENATED MODULE: ./src/methods/getContentItem.js
function getContentItem_objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {getContentItem_defineProperty(target, key, source[key]);});}return target;}function getContentItem_defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
function getContentItem(requestParams) {
  ...
  getContentItem_validateRequestParams(requestParams);

  //merge default params with request params
  requestParams = getContentItem_objectSpread({}, defaultParams, requestParams);

  var req = {
    url: "/item/".concat(requestParams.contentID, "?contentLinkDepth=").concat(requestParams.contentLinkDepth),
    method: 'get',
    baseURL: buildRequestUrlPath(this.config, requestParams.languageCode),
    headers: buildAuthHeader(this.config),
    params: {} };
...
function getContentItem_validateRequestParams(requestParams) {
  if (!requestParams.languageCode) {
    throw new TypeError('You must include a languageCode in your request params.');
  } else
...
/* harmony default export */ var methods_getContentItem = (getContentItem);
// CONCATENATED MODULE: ./src/methods/getContentList.js
function getContentList_objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {getContentList_defineProperty(target, key, source[key]);});}return target;}function getContentList_defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
function getContentList(requestParams) {
  ...
  getContentList_validateRequestParams(requestParams);

  //merge default params with request params
  requestParams = getContentList_objectSpread({}, getContentList_defaultParams, requestParams);
...
function getContentList_validateRequestParams(requestParams) {
  if (!requestParams.languageCode) {
    throw new TypeError('You must include a languageCode in your request params.');
  } else
  if (!requestParams.referenceName) {
    ...
    //check if the request direction parameter is valid
    for (var i = 0; i < requestParams.filters.length; i++) {
      var filter = requestParams.filters[i];
...
var getContentList_defaultParams = {
  contentLinkDepth: 1 };


/* harmony default export */ var methods_getContentList = (getContentList);
// CONCATENATED MODULE: ./src/methods/getPage.js
function getPage_objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {getPage_defineProperty(target, key, source[key]);});}return target;}function getPage_defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
function getPage(requestParams) {
  ...
  getPage_validateRequestParams(requestParams);

  //merge default params with request params
  requestParams = getPage_objectSpread({}, getPage_defaultParams, requestParams);

  var req = {
    url: "/page/".concat(requestParams.pageID, "?contentLinkDepth=").concat(requestParams.contentLinkDepth),
    method: 'get',
    baseURL: buildRequestUrlPath(this.config, requestParams.languageCode),
    headers: buildAuthHeader(this.config),
    params: {} };
...
function getPage_validateRequestParams(requestParams) {
  if (!requestParams.languageCode) {
    throw new TypeError('You must include a languageCode in your request params.');
...
var getPage_defaultParams = {
  contentLinkDepth: 2 };



/* harmony default export */ var methods_getPage = (getPage);
// CONCATENATED MODULE: ./src/methods/getGallery.js
function getGallery_objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {getGallery_defineProperty(target, key, source[key]);});}return target;}function getGallery_defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
function getGallery(requestParams) {
  ...
  getGallery_validateRequestParams(requestParams);

  //merge default params with request params
  requestParams = getGallery_objectSpread({}, getGallery_defaultParams, requestParams);

  var req = {
    url: "/".concat(requestParams.galleryID),
    method: 'get',
...
function getGallery_validateRequestParams(requestParams) {
...
var getGallery_defaultParams = {
  contentLinkDepth: 1 };


/* harmony default export */ var methods_getGallery = (getGallery);
// CONCATENATED MODULE: ./src/methods/syncContentItems.js
...
function syncContentItems(requestParams) {
  ...
  syncContentItems_validateRequestParams(requestParams);

  var req = {
    url: "/sync/items?pageSize=".concat(requestParams.pageSize, "&ticks=").concat(requestParams.ticks),
    method: 'get',
    baseURL: buildRequestUrlPath(this.config, requestParams.languageCode),
    headers: buildAuthHeader(this.config),
    params: {} };
...
function syncContentItems_validateRequestParams(requestParams) {
  if (!requestParams.languageCode) {
    throw new TypeError('You must include a languageCode in your request params.');
  } else
  if (requestParams.ticks == undefined || requestParams.ticks == null) {
...
/* harmony default export */ var methods_syncContentItems = (syncContentItems);
// CONCATENATED MODULE: ./src/methods/syncPageItems.js
...
function syncPageItems(requestParams) {
  ...
  syncPageItems_validateRequestParams(requestParams);

  var req = {
    url: "/sync/pages?pageSize=".concat(requestParams.pageSize, "&ticks=").concat(requestParams.ticks),
    method: 'get',
    baseURL: buildRequestUrlPath(this.config, requestParams.languageCode),
    headers: buildAuthHeader(this.config),
    params: {} };
...
function syncPageItems_validateRequestParams(requestParams) {
  if (!requestParams.languageCode) {
    throw new TypeError('You must include a languageCode in your request params.');
  } else
  if (requestParams.ticks == undefined || requestParams.ticks == null) {
...
/* harmony default export */ var methods_syncPageItems = (syncPageItems);
// CONCATENATED MODULE: ./src/types/FilterOperator.js
/**
...
/* harmony default export */ var FilterOperator = (FilterOperators);
// CONCATENATED MODULE: ./src/types/FilterLogicOperator.js
/**
...
/* harmony default export */ var FilterLogicOperator = (FilterLogicOperators);
// CONCATENATED MODULE: ./src/types/SortDirection.js
/**
...
/* harmony default export */ var SortDirection = (SortDirections);
// CONCATENATED MODULE: ./src/api-client.js
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function api_client_objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {api_client_defineProperty(target, key, source[key]);});}return target;}function api_client_defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
function createClient(userConfig) {
  ...
  var config = api_client_objectSpread({},
  defaultConfig,
  userConfig);
  ...
  if (!config.baseUrl) {
    //use default url
    config.baseUrl = "https://".concat(config.guid, "-api.agilitycms.cloud");
  } else {
  ...
  if (config.caching.maxAge > 0) {
    var cache = Object(cache_node["setupCache"])({
  ...
  function makeRequest(reqConfig) {
    ...
    if (config.debug) {
      logDebug("AgilityCMS Fetch API LOG: ".concat(reqConfig.baseURL).concat(reqConfig.url));
    }

    //make the request using our axios instance
    return api(reqConfig).then( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(response) {var data;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                data);case 3:case "end":return _context.stop();}}}, _callee);}));return function (_x) {return _ref.apply(this, arguments);};}()).

    catch( /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(error) {return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                logError("AgilityCMS Fetch API ERROR: Request failed for ".concat(reqConfig.baseURL).concat(reqConfig.url, " ... ").concat(error, " ... Does the item exist?"));case 1:case "end":return _context2.stop();}}}, _callee2);}));return function (_x2) {return _ref2.apply(this, arguments);};}());
  ...
  return {
    ...
    getSitemapFlat: methods_getSitemapFlat,
    getSitemapNested: methods_getSitemapNested,
    getContentItem: methods_getContentItem,
    getContentList: methods_getContentList,
    getPage: methods_getPage,
    getGallery: methods_getGallery,
    syncContentItems: methods_syncContentItems,
    syncPageItems: methods_syncPageItems,
    types: {
      FilterOperators: FilterOperator,
      FilterLogicOperators: FilterLogicOperator,
      SortDirections: SortDirection } };



}
// CONCATENATED MODULE: ./src/content-fetch.js
/**
...
function validateConfigParams(configParams) {
  ...
  if (!configParams.guid || configParams.guid.length == 0) {
    ...
    throw new TypeError("When specifying a baseUrl (".concat(configParams.baseUrl, "), it must be over HTTPs."));
  } else {
    return;
  }
}
...
/* harmony default export */ var content_fetch = __webpack_exports__["default"] = ({
  getApi: getApi });
